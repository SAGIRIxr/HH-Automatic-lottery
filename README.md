...
* 📊 **定时周期统计简报**：
  * 支持设置每隔 1 小时（或自定义分钟）推送一次时段战报（包含近 1 小时抽数、收支、盈亏比率、分奖项明细与挂机累计总览）。
* 💾 **历史记录导出与合并导入**：
...
* 🛡️ **完善的抗风控与异常保护**：
  ...
  * 监听 `Ctrl-C` / `SIGTERM` 信号，退出前必定先落盘已抽数据并推送停止报告。
...
🕒 中奖时间：08/20 16:30:15
🎯 当前抽数：本次第 520 抽（历史累计 3,250 抽）
💰 当前余额：4,860,200 憨豆
━━━━━━━━━━━━━━━━━━━
📈 本次运行战报：
  • 已抽次数：520 抽
  • 消耗憨豆：1,040,000
  • 获得憨豆：1,850,000（含 VIP 折算）
  • 累计盈亏：+810,000（+77.9%）
━━━━━━━━━━━━━━━━━━━
🤖 状态：后台持续挂机抽奖中...
```
...
📊【HHCLUB 幸运大转盘 · 运行简报】
━━━━━━━━━━━━━━━━━━━
⏱️ 统计时段：近 60 分钟 (已运行 2小时 15分)
🎰 时段抽数：420 抽
💰 憨豆收支：消耗 840,000 · 获得 1,150,000（含折算 1,000,000）
📈 时段盈亏：+310,000（+36.9%）
💵 当前余额：3,580,240 憨豆
━━━━━━━━━━━━━━━━━━━
🎁 本时段奖品明细：
...
━━━━━━━━━━━━━━━━━━━
📊 挂机累计数据：
  • 本次累计抽数：960 抽（历史总计 4,200 抽）
  • 本次累计盈亏：+520,000（+27.1%）
━━━━━━━━━━━━━━━━━━━
🤖 状态：后台持续监控与抽奖中 | 播报时间：08/20 17:00:00
```
